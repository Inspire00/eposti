    ...
    <> {/* Replaced Layout with a Fragment */}
      ...
      <div className="bg-white p-8 rounded-xl shadow-lg text-gray-700 leading-relaxed">
        ...
        <ol className="list-decimal list-inside mb-8 space-y-3">
          ...
          <li>
            **WhatsApp for Pictures:** Once you have submitted the form, open WhatsApp and send List a room to our dedicated chatbot at **YOUR_WHATSAPP_BUSINESS_NUMBER**. The bot will then prompt you to send 1 to 3 pictures of your room. Our AI will automatically link these images to your submitted details.
          </li>
          <li>
        ...
        <ol className="list-decimal list-inside space-y-3">
          ...
          <li>
            **Contact Directly:** Once you find a room you are interested in, simply click the Contact on WhatsApp button. This will open a chat with the room posters designated WhatsApp number, pre-filled with a message indicating your interest.
          </li>
          <li>
            **Chatbot Search (Advanced):** Alternatively, you can directly message our WhatsApp chatbot at **YOUR_WHATSAPP_BUSINESS_NUMBER** and say I am looking for a room. The bot will then ask you for your preferences (e.g., location, budget) and send you details of matching listings, including pictures, directly in the chat.
          </li>
        </ol>
        <p className="mt-8">
